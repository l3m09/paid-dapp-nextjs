    ...
    return (
        <IonPage >
            ...
            <IonContent fullscreen class="phrase-content phrase-completed">
                ...
                <IonItem>
                    <IonText class="phrase-content-sub-text phrase-completed-sub-text">
                        <span className="text-brand-primary">
                            <IonRouterLink class="text-brand-primary" onClick={() => setShowModal(true)}>
                ...
                <IonItem>
                    <IonText class="phrase-content-sub-text phrase-completed-sub-text">
                        Paid cannot recover your wallet should you lose it. You can find your seed phrase in Settings.
                    </IonText>
                </IonItem>
                <IonItem>
                    <IonText class="phrase-content-sub-text phrase-completed-sub-text">

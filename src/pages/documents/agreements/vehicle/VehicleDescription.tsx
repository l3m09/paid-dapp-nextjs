			...
			<IonItem>
				<div className="instructions">
					...
					<ul className="instructions-list first">
						<li>
							That the vehicle is free and clear of all liens and encumbrances and that the title is clean and not
							salvage.
						</li>
						<li>
						...
						<li>
							That the vehicle is in the same condition as it was when the offer to purchase was executed.
						</li>
						<li>
							The vehicle was delivered to (SELLER) during normal
					...
					<ul className="instructions-list first">
						...
						<li>
							Salvage titles, unknown miles, and child support liens will automatically disqualify the vehicle from
							purchase
						</li>
					</ul>
					<IonButton
